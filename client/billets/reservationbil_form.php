...
if(isset($_POST['submit_reservation'])) {
    ...
    $compte_id = $user_id;
    $billet_id = $_POST['billet_id'] ?? null;
    ...
    $query = "INSERT INTO reservation (user_id, compte_id, type, billet_id, date_reservation, name, email, passport_number) 
              VALUES ('$user_id', '$compte_id', 'billet', '$billet_id', '$date_reservation', '$name', '$email', '$passport_number')";
...
<head>
    ...
    <title>Reservation Billet</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container">
        <div>
            <h1>Reservation Billet</h1>
            <form method="post" action="">
                <!-- Include a hidden field for the billet ID -->
                <input type="hidden" name="billet_id" value="<?php echo $_SESSION['billet_id'] ?? ''; ?>">
