...
if(isset($_POST['submit_reservation'])) {
    ...
    $query = "INSERT INTO reservation (user_id, compte_id, type, restaurant_id, date_reservation, name, email, passport_number) 
              VALUES ('$user_id', '$compte_id', 'restaurant', '$restaurant_id', '$date_reservation', '$name', '$email', '$passport_number')";
...
<body>
    ...
    <div class="container">
        <div>
            <h1>Reservation Restaurent</h1>
            <form method="post" action="">
                <!-- Include a hidden field for the restaurant ID -->
